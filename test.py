...
test_fb_node = simulation.Post(G, 0.8, 1)
test_fb_node.run('near', .1)
# E = nx.path_graph([0,1,2])
# small_test = simulation.Post(E, 0.8, 0.5)
# small_test.run('near', .75)
...
# 		small_test.assign_weight(node, 'near', .75)
